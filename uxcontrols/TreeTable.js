sap.ui.define([
    ...
    "use strict";
    var oControl = Control.extend("vistex.control.TreeTable", {
        metadata: {
            properties: {},
            aggregations: {
                columns: {type: "vistex.control.TreeTableColumn", multiple: true},
        ...
        renderer: {
            ...
            renderRows: function (oRm, oControl) {
                ...
                aRows.forEach(function (oRow, iRowIndex) {
                    this.renderRow(oRm, oRow, iRowIndex, aRows, aRowExpantion, ++iGlobalIndex);
                }.bind(this));

                oRm.write("</div>");
            },

            renderRow: function (oRm, oRow, iRowIndex, aRows, aRowExpantion, iGlobalIndex) {
                ...
                aCells.forEach(function (oCell, iCellIndex) {
                    ...
                    var aCellExpansion = aRowExpantion[iGlobalIndex][iCellIndex] || [];
                ...
                if (aChilds.length > 0) {
                    aChilds.forEach(function (oChildRow, iRowIndex) {
                        this.renderRow(oRm, oChildRow, iRowIndex, aChilds, aRowExpantion, ++iGlobalIndex);
                    }.bind(this))
                }
            },
