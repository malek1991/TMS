sap.ui.define([
    ...
    var oLineVariant = VizFrame.extend("vistex.control.vizframe.LineVariant", {
        ...
        addDimensionFeed: function () {
            ...
            for (i = 0; i < aDimensions.length; i++) {
                var dimensionName = aDimensions[i].getName().toString();
                if (dimensionName) {
                    aValues.push(dimensionName);
                }
            }
        ...
        addMeasuresFeed: function () {
            ...
            if (this.getVizType() && this.getVizType() === "vertical_bullet") {
