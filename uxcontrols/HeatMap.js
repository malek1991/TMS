sap.ui.define([
    ...
    var oControl = Control.extend("vistex.control.HeatMap", {
        metadata: {
            properties: {
            ...
            aggregations: {
                ...
                legend: {"type":"vistex.control.HeatMapLegend", "multiple": false}
            }
        },
        ...
        onScrollDetectorMouseMove: function (n) {
            ...
            $(".vuiHtMpHdrCntCell").each(function(i, value) {
                var col = $(value);
                col.offset({
                    left: $(".vuiHtMpRowCell-" + i).offset().left - 27,
        ...
        renderer:{
            ...
            renderCells:function (oRm, oRow, oControl) {
                ...
                aColumns.forEach(function (oColumn, iIndex) {
                    this.renderCell(oRm, oColumn, aCells, iIndex);
                }.bind(this));
            },

            renderCell:function (oRm, oColumn, aCells, iIndex, oParentColumn) {
                ...
                oRm.writeClasses();
                oRm.writeAttribute("title", aCells[iIndex].getValue());
                oRm.write(">");
                ...
                oRm.addClass("vuiHtMpRowCell-" + iIndex);
                ...
                oRm.addStyle("background", aCells[iIndex].getColor());
                oRm.writeStyles();
                oRm.write(">");
                oRm.write("</div>");
                ...
                oColumn.getColumns().forEach(function (oChildColumn) {
                    this.renderCell(oRm, oChildColumn, aCells, iIndex, oColumn);
                    iIndex++;
                }.bind(this));
            }
        }
