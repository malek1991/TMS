sap.ui.define([
    ...
    "sap/m/Label",
    "sap/m/ObjectStatus",
    "vistex/tms/uxcontrols/Availability"
], function (Control, HBox, VBox, Image, Label, ObjectStatus, Availability) {
    "use strict";
    var oControl = Control.extend("vistex.control.AvailsDialogHeader", {
        metadata: {
            properties: {
            ...
            associations: {
                ...
                _availability: {type: "vistex.ds.Availability", multiple: false},
